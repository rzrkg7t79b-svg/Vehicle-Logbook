  ...
  return (
    <div className="pb-24">
      <div className="relative overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[300px] h-[200px] bg-purple-500/15 blur-[100px] rounded-full" />
        <div className="relative p-6 pt-8">
          ...
          <p className="text-sm text-white/50">Daily Task List</p>
        </div>
      </div>
      ...
      <div className="p-4 space-y-4">
        ...
        <footer className="mt-8 pt-8 border-t border-white/10 text-center space-y-1">
          <p className="text-xs text-muted-foreground">Version v3.2.2</p>
